...
function App() {
    ...
    return <h1>{message}</h1>                       // JSX is a mix of JS and HTML. We can use JS expressions inside of JSX by wrapping them in curly braces. This is called 'interpolation
}
